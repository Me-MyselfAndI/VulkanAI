...
from compression.scraping.driverHTML import DriverHTML
...
class SearchEngine:
    ...
    def get_website(self, link_number=None, url=None):
        ...
        driver = DriverHTML(website_url, headless=False)
        website_content = driver.fetch_page_html(scroll_count=10, timeout=10)

        soup = BeautifulSoup(website_content['full-html'], 'html.parser')
...
if __name__ == '__main__':
    ...
    page = search_engine.get_website(url=search_engine.get_website(0)['url'])
